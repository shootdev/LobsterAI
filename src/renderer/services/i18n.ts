...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imConnectivityCheckTitle_qzhuli_bridge_hint: 'Q助理 网关桥接',
    ...
    imConnectivityCheckSuggestion_qzhuli_bridge_hint: '确认 senderCid、convId、wsToken 填写正确，并检查当前环境域名连通性。',
    ...
    scheduledTasksFormNotifyQzhuli: 'Q助理',
  ...
  en: {
    ...
    imConnectivityCheckTitle_qzhuli_bridge_hint: 'QZhuli Bridge',
    ...
    imConnectivityCheckSuggestion_qzhuli_bridge_hint: 'Ensure senderCid, convId, and wsToken are correct, and verify connectivity to environment host.',
    ...
    scheduledTasksFormNotifyQzhuli: 'QZhuli',
