...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'Q助理电脑机器人 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 Q助理电脑机器人 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 Q助理电脑机器人 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'Q助理电脑机器人 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkConfigSaveFailed: '保存 Q助理电脑机器人 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'Q助理电脑机器人 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'Q助理电脑机器人 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    imQzhuliScanBtn: '扫码绑定 Q助理',
    imQzhuliScanHint: '使用 Q助理 App 扫码，自动填入会话参数',
    imQzhuliBindModalTitle: '登录Q助理电脑机器人',
    imQzhuliBindModalHint: '用Q助理扫一扫',
    imQzhuliBindModalSubHint: '打开 Q助理 App → 扫码登录',
    imQzhuliBindSuccess: '已绑定成功 ✓',
    imQzhuliBindPollingFailed: '绑定状态轮询失败',
    ...
    // 隐私协议弹窗
    privacyDialogTitle: '网易有道Q助理电脑机器人服务协议',
    privacyDialogDesc: '在使用网易有道Q助理电脑机器人之前，请您仔细阅读{link}内容，并进行确认。',
    privacyDialogLinkText: '网易有道Q助理电脑机器人服务协议',
  ...
  en: {
    ...
    // Q助理电脑机器人
    cowork: 'Q助理电脑机器人',
    coworkSettings: 'Q助理电脑机器人 Settings',
    ...
    coworkWorkingDirectoryHint: 'Q助理电脑机器人 will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for Q助理电脑机器人...',
    coworkSystemPromptHint: 'Optional system prompt to customize Q助理电脑机器人\'s behavior',
    ...
    coworkModelSettingsHint: 'Q助理电脑机器人 uses the current model and provider configuration from Model Settings.',
    ...
    coworkConfigSaveFailed: 'Failed to save Q助理电脑机器人 settings. Please try again.',
    ...
    coworkPermissionDescription: 'Q助理电脑机器人 is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'QZhuli needs your input',
    ...
    imQzhuliScanBtn: 'Scan to Bind QZhuli',
    imQzhuliScanHint: 'Scan with QZhuli app to auto-fill conversation credentials',
    imQzhuliBindModalTitle: 'Sign in to QZhuli Desktop Bot',
    imQzhuliBindModalHint: 'Scan with QZhuli app',
    imQzhuliBindModalSubHint: 'Open QZhuli app -> Scan QR code to sign in',
    imQzhuliBindSuccess: 'Bound successfully',
    imQzhuliBindPollingFailed: 'Failed to poll bind status',
    ...
    // Privacy dialog
    privacyDialogTitle: 'NetEase Youdao Q助理电脑机器人 Terms of Service',
    privacyDialogDesc: 'Before using NetEase Youdao Q助理电脑机器人, please carefully read the {link} and confirm.',
    privacyDialogLinkText: 'NetEase Youdao Q助理电脑机器人 Terms of Service',
