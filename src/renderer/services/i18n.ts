...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    imConnectivityCheckTitle_imnut_bridge_hint: 'Q助理 网关桥接',
    ...
    imConnectivityCheckSuggestion_imnut_bridge_hint: '确认 senderCid、convId、wsToken 填写正确，并检查当前环境域名连通性。',
    ...
    scheduledTasksFormNotifyImnut: 'Q助理',
  ...
  en: {
    ...
    imConnectivityCheckTitle_imnut_bridge_hint: 'QZhuli Bridge',
    ...
    imConnectivityCheckSuggestion_imnut_bridge_hint: 'Ensure senderCid, convId, and wsToken are correct, and verify connectivity to environment host.',
    ...
    scheduledTasksFormNotifyImnut: 'QZhuli',
